...
<div class="container">
    ...
    <div class="row justify-content-center py7">
      <div class="col-md-7">
        <button class="btn btn-primary btn-block" id="btn-show-tables">Lihat Semua Meja</button>
      ...
      <div class="col-md-5">
        ...
        <div id="list-menu" class="row mt-4"></div>
      </div>
    </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="payment">Pembayaran Type</label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary btn-save-payment" disabled>Simpan Pembayaran</button>
      </div>
    </div>
  </div>
</div>
...
$(document).ready(function(){
  ...
  $("#recieved-amount").keyup(function(){
    ...
    $(".changeAmount").html("Kembali: " + changeAmount);
