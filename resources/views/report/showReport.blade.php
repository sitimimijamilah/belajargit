    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/home">Laporan</a></li>
        ...
        <div class="col-md-12">
          @if($sales->count() > 0)
            <div class="alert alert-success" role="alert">
              <p>Total Penjualan  Dari Tanggal {{$dateStart}} Sampai {{$dateEnd}}  Rp.{{number_format($totalSale, 2)}}</p>
              <p>Total Penjualan: {{$sales->total()}}</p>
            </div>
            <table class="table">
              <thead>
