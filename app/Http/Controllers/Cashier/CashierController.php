    ...
    private function getSaleDetails($sale_id){
        ...
        foreach($saleDetails as $saleDetail){
            ...
            <tr>
                ...
                <td>'.$saleDetail->quantity.'<button data-id="'.$saleDetail->id.'" class="btn btn-info btn-sm btn-increase-quantity">+</button></td>
        ...
        $html .= '<hr>';
        $html .= '<h3>Total Amount: Rp'.number_format($sale->total_price).'</h3>';
        ...
        if($showBtnPayment){
            ...
            $html .= '<button data-id="'.$sale_id.'" class="btn btn-warning btn-block btn-confirm-order">Konfirmasi Pesanan</button>';
        }
